        ...
        <div className="about-container">
          ...
          >
            ...
            <div className="our-story-content">
              ...
              אנחנו ב-OMC מאמינים שתשוקה וכישרון הם המפתחות להצלחה. הצוות שלנו מורכב מאנשים שחיים את מה שהם עושים ומביאים איתם אנרגיה, חיוך והמון יצירתיות. בין אם זו חתונת השנה או Happy Hour בחברה שלכם אנחנו מתחייבים להרים את האירוע שלכם כמה רמות למעלה.
            </div>
          </motion.div>
              ...
              <>
                ...
                >
                  ...
                  <p className="omer-description">
                    עומר, המייסד והבעלים של OMC, בוגר מיקסולוגיה בפריז עם 15 שנות ניסיון בעולם הקוקטיילים המרתק. החוש האסתטי, היצירתיות והמעוף של עומר, יחד עם הנסיון העשיר שלו מביאים את OMC להיות המובילים בתחום וללא מתחרים.
                  </p>
                </motion.div>
              </>
            ) : (
