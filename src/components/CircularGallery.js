...
function createTextTexture(gl, text, font = "900 30px 'Heebo', sans-serif", color = "black") {
...
// ========================================================================================
class Title {
  constructor({ gl, plane, renderer, text, textColor = "#545050", font = "900 30px 'Heebo', sans-serif" }) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
...
class App {
  constructor(container, {
    items, bend, textColor = "#ffffff", font = "900 30px 'Heebo', sans-serif",
...
export default function CircularGallery({
  ...
  bend = 3,
  textColor = "#ffffff",
  font = "900 30px 'Heebo', sans-serif",
  scrollSpeed = 2,
  scrollEase = 0.05,
}) {
