...
import SEO from './SEO';
import { mainPageGalleryItems } from '../data/galleryData';
...
const GallerySection = React.memo(() => {
  ...
  return (
    <section style={{
      ...
      <PinterestGalleryNew items={mainPageGalleryItems} />
    </section>
  );
});
...
const FAQSection = React.memo(() => {
  ...
  const faqData = useMemo(() => [
    {
      question: "כיצד מזמינים את השירות?",
    ...
    {
      question: "לאילו אירועים אתם מספקים את השירות?",
    ...
    {
      question: "האם הציוד והחומרים מסופקים על ידכם?",
    ...
    {
      question: "אילו סוגי משקאות אתם מכינים?",
      ...
      <div className="mainpage-container">
        ...
        <footer style={{
          ...
          <style>{`
            ...
            .footer-social-icon:hover .footer-social-filled {
              height: 100%;
            }

            .footer-social-icon[data-social="instagram"] .footer-social-filled {
              background: linear-gradient(45deg, #405de6, #5b51db, #b33ab4, #c135b4, #e1306c, #fd1f1f);
            }

            .footer-social-icon[data-social="facebook"] .footer-social-filled {
          ...
          <div style={{
            ...
            <div className="footer-links-container" style={{
              ...
              <Link to="/services" className="footer-link">שירותים</Link>
              <Link to="/about" className="footer-link">אודות</Link>
              <Link to="/gallery" className="footer-link">גלריה</Link>
              <Link to="/blog" className="footer-link">בלוג</Link>
              <Link to="/contact" className="footer-link">צור קשר</Link>
              <Link to="/accessibility" className="footer-link" style={{ color: '#C9A14B' }}>הצהרת נגישות</Link>
            </div>
            ...
            <div style={{
              ...
              >
                ...
                <div className="footer-social-filled"></div>
              </a>
